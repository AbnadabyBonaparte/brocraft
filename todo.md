...
- [x] Botão "Resetar Chat" não está funcionando - não limpa o histórico de mensagens (CORRIGIDO: import useAuth faltando)
...
## Fase 11: Expansão Visual e Design Premium (NOVA)

- [ ] Gerar imagens de fundo para categorias (cerveja, fermentados, queijos, charcutaria)
- [ ] Criar hero section com imagem de fundo profissional
- [ ] Implementar landing page com seções (Hero, Features, Testimonials, CTA, FAQ)
- [ ] Adicionar modal de seleção de nível (Rajado/Clássico/Mestre)
- [ ] Criar componente de detalhes de receita expandido
- [ ] Implementar stats section com números impressionantes
- [ ] Adicionar testimonials/reviews de usuários
- [ ] Otimizar responsividade para mobile/tablet/desktop
- [ ] Implementar lazy loading de imagens
- [ ] Adicionar animações de scroll (AOS - Animate On Scroll)
- [ ] Criar componente de pricing com comparação de tiers
- [ ] Implementar FAQ section com accordion
- [ ] Adicionar breadcrumbs de navegação
- [ ] Criar 404 page customizada
- [ ] Implementar loading states sofisticados

## Fase 12: Seed de Receitas (50 Receitas Base)
...
## Fase 17: Sistema de Histórico de Conversas (NOVA)

- [ ] Adicionar tabela de histórico de conversas no banco de dados (conversationHistory)
- [ ] Implementar função para salvar histórico quando resetar
- [ ] Criar página de Histórico de Conversas (visualizar conversas antigas)
- [ ] Fazer botão resetar limpar tela E salvar histórico
- [ ] Testar fluxo completo (resetar → salva histórico → tela limpa)
- [ ] Adicionar link para página de histórico na sidebar
