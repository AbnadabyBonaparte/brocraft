        ...
        <Card className="bg-card/80 border-border backdrop-blur-sm p-8">
          ...
          <div className="prose prose-invert prose-orange max-w-none">
            ...
            <p className="text-foreground/90">
              O BROCRAFT respeita sua privacidade. Esta política explica como
            ...
            <div className="bg-muted/50 rounded-lg p-4 my-4">
              <ul className="text-foreground/90 space-y-2">
                <li>
                  <strong>Dados de Conta:</strong> Nome, email, foto de perfil
                  (via OAuth)
                </li>
                <li>
                  <strong>Dados de Uso:</strong> Mensagens ao assistente,
                  receitas, XP, badges
                </li>
                <li>
                  <strong>Dados Técnicos:</strong> IP, navegador, sistema
                  operacional
                </li>
                <li>
                  <strong>Pagamentos:</strong> Processados pelo Stripe (não
                  armazenamos cartões)
                </li>
              </ul>
            </div>
            ...
            <p className="text-foreground/90">
              ...
              serviço (Stripe para pagamentos), requisições legais, ou para
            ...
            <ul className="text-foreground/90 mt-2">
